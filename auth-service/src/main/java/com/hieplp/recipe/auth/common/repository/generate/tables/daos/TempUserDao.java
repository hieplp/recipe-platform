...
public class TempUserDao extends DAOImpl<TempUserRecord, com.hieplp.recipe.auth.common.repository.generate.tables.pojos.TempUser, String> {
     ...
     */
    public List<com.hieplp.recipe.auth.common.repository.generate.tables.pojos.TempUser> fetchRangeOfOtpid(String lowerInclusive, String upperInclusive) {
        return fetchRange(TempUser.TEMP_USER.OTPID, lowerInclusive, upperInclusive);
    }

    /**
     * Fetch records that have <code>otpId IN (values)</code>
     */
    public List<com.hieplp.recipe.auth.common.repository.generate.tables.pojos.TempUser> fetchByOtpid(String... values) {
        return fetch(TempUser.TEMP_USER.OTPID, values);
    }
