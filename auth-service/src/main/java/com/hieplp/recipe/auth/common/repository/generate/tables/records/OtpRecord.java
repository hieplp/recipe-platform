...
public class OtpRecord extends UpdatableRecordImpl<OtpRecord> implements Record10<String, String, String, Byte, LocalDateTime, LocalDateTime, LocalDateTime, String, LocalDateTime, String> {
     ...
     */
    public OtpRecord(String otpid, String sendto, String otpcode, Byte status, LocalDateTime issuedat, LocalDateTime expiredat, LocalDateTime createdat, String createdby, LocalDateTime modifiedat, String modifiedby) {
        super(Otp.OTP);
