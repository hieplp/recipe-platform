 ...
 */
package com.hieplp.recipe.auth.repository.generate.tables;


import com.hieplp.recipe.auth.repository.generate.Authentication;
import com.hieplp.recipe.auth.repository.generate.Keys;
...
public class Otp extends TableImpl<OtpRecord> {
    ...
    /**
     * The column <code>authentication.otp.otpIssuedAt</code>.
     */
    public final TableField<OtpRecord, LocalDateTime> OTPISSUEDAT = createField(DSL.name("otpIssuedAt"), SQLDataType.LOCALDATETIME(0).defaultValue(DSL.inline("NULL", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>authentication.otp.otpExpiredAt</code>.
     */
    public final TableField<OtpRecord, LocalDateTime> OTPEXPIREDAT = createField(DSL.name("otpExpiredAt"), SQLDataType.LOCALDATETIME(0).defaultValue(DSL.inline("NULL", SQLDataType.LOCALDATETIME)), this, "");
