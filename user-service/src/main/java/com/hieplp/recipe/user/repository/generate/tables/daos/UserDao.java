...
import com.hieplp.recipe.user.repository.generate.tables.pojos.User;
...
public class UserDao extends DAOImpl<UserRecord, User, String> {
     ...
     */
    public UserDao() {
        super(com.hieplp.recipe.user.repository.generate.tables.User.USER_, User.class);
    }
    ...
    public UserDao(Configuration configuration) {
        super(com.hieplp.recipe.user.repository.generate.tables.User.USER_, User.class, configuration);
    }
    ...
    public List<User> fetchRangeOfUserid(String lowerInclusive, String upperInclusive) {
        return fetchRange(com.hieplp.recipe.user.repository.generate.tables.User.USER_.USERID, lowerInclusive, upperInclusive);
    }
    ...
    public List<User> fetchByUserid(String... values) {
        return fetch(com.hieplp.recipe.user.repository.generate.tables.User.USER_.USERID, values);
    }
    ...
    public User fetchOneByUserid(String value) {
        return fetchOne(com.hieplp.recipe.user.repository.generate.tables.User.USER_.USERID, value);
    }
    ...
    public List<User> fetchRangeOfUsername(String lowerInclusive, String upperInclusive) {
        return fetchRange(com.hieplp.recipe.user.repository.generate.tables.User.USER_.USERNAME, lowerInclusive, upperInclusive);
    }
    ...
    public List<User> fetchByUsername(String... values) {
        return fetch(com.hieplp.recipe.user.repository.generate.tables.User.USER_.USERNAME, values);
    }
    ...
    public User fetchOneByUsername(String value) {
        return fetchOne(com.hieplp.recipe.user.repository.generate.tables.User.USER_.USERNAME, value);
    }
    ...
    public List<User> fetchRangeOfFullname(String lowerInclusive, String upperInclusive) {
        return fetchRange(com.hieplp.recipe.user.repository.generate.tables.User.USER_.FULLNAME, lowerInclusive, upperInclusive);
    }
    ...
    public List<User> fetchByFullname(String... values) {
        return fetch(com.hieplp.recipe.user.repository.generate.tables.User.USER_.FULLNAME, values);
    }
    ...
    public List<User> fetchRangeOfStatus(Byte lowerInclusive, Byte upperInclusive) {
        return fetchRange(com.hieplp.recipe.user.repository.generate.tables.User.USER_.STATUS, lowerInclusive, upperInclusive);
    }
    ...
    public List<User> fetchByStatus(Byte... values) {
        return fetch(com.hieplp.recipe.user.repository.generate.tables.User.USER_.STATUS, values);
    }
    ...
    public List<User> fetchRangeOfCreatedby(String lowerInclusive, String upperInclusive) {
        return fetchRange(com.hieplp.recipe.user.repository.generate.tables.User.USER_.CREATEDBY, lowerInclusive, upperInclusive);
    }
    ...
    public List<User> fetchByCreatedby(String... values) {
        return fetch(com.hieplp.recipe.user.repository.generate.tables.User.USER_.CREATEDBY, values);
    }
    ...
    public List<User> fetchRangeOfCreatedat(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
        return fetchRange(com.hieplp.recipe.user.repository.generate.tables.User.USER_.CREATEDAT, lowerInclusive, upperInclusive);
    }
    ...
    public List<User> fetchByCreatedat(LocalDateTime... values) {
        return fetch(com.hieplp.recipe.user.repository.generate.tables.User.USER_.CREATEDAT, values);
    }
    ...
    public List<User> fetchRangeOfModifiedby(String lowerInclusive, String upperInclusive) {
        return fetchRange(com.hieplp.recipe.user.repository.generate.tables.User.USER_.MODIFIEDBY, lowerInclusive, upperInclusive);
    }
    ...
    public List<User> fetchByModifiedby(String... values) {
        return fetch(com.hieplp.recipe.user.repository.generate.tables.User.USER_.MODIFIEDBY, values);
    }
    ...
    public List<User> fetchRangeOfModifiedat(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
        return fetchRange(com.hieplp.recipe.user.repository.generate.tables.User.USER_.MODIFIEDAT, lowerInclusive, upperInclusive);
    }
    ...
    public List<User> fetchByModifiedat(LocalDateTime... values) {
        return fetch(com.hieplp.recipe.user.repository.generate.tables.User.USER_.MODIFIEDAT, values);
    }
}
